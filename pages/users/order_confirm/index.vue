<template>
	<view>
		<view class='order-submission my_order'>
			<view class="bg">
				<span class="anquan">
			...
			<view class='wrapper'>
				...
				<view class='item acea-row row-between-wrapper peisong' v-if='shippingType==0'>
					<span class="psfs2">
					...
					<view class="psfs3">
						...
						<view class='discount' v-else>免费包邮</view>
					</view>
				</view>
				<view v-else>
			...
			<view class="tjdd">
				<span class="tjdd1">
					...
					<view class="tjdd12">
						<view></view>
						<view class="tjdd13">
							{{integral_price}}积分+{{totalPrice || 0}}元
						</view>
					</view>
				</span>
