			...
			<view class="bdsj">
				<view class="bdsj2">
					<view>
						...
						<span>
							<p @click="goMenuPage('/pages/users/user_integral/index')" style="font-size: 0.8rem;color: #747474;">您当前积分为：{{userInfo.integral || 0}}</p>
							<p style="font-size: 0.6rem;color: #fb5074;">点此绑定手机，再送999积分</p>
						</span>
					</view>
				</view>
				<view class="bdsj3">
					...
					<view>
						<p>
							<image class="mckf" src="../../static/mycenter/m4.png" mode=""></image>
						</p>
						<p>销售员中心</p>
					</view>
					<view>
						<p>
							<image class="mckf" src="../../static/mycenter/m5.png" mode=""></image>
						</p>
						<p>APP下载</p>
					</view>
					<view>
						<p>
							<image class="mckf" src="../../static/mycenter/m6.png" mode=""></image>
						</p>
						<p>平台投诉</p>
					</view>
				</view>
