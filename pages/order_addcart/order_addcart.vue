...
<style scoped>
	.ddym{background-color: #f5f5f5;}
	/* .sousuobf{width: 100%;padding: 0 10px;display: flex;justify-content: space-between;display: inline-block;}*/
	 .sousuobf{width: 100%;padding: 0 10px;}
	.sousuobf button{
		width: 20%;
...
<style scoped>	
	/deep/ .search_input_wrapper{margin-top: 3%;width: 70%;float: left;}
	/deep/ uni-input{height: 40px;}
	/deep/ .search_input_foucs{margin-right: -5%;}
	/deep/ .search_bar{width: 80%;}
	/deep/ .search_input_wrapper .search_input_foucs{border: 1px solid #D3D3D3;border-radius: 8px;}
</style>