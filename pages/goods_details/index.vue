<template>
	<view class="product-con">
			...
			<scroll-view :scroll-top="scrollTop" scroll-y='true' scroll-with-animation="true" :style='"height:"+height+"px;"'
			 @scroll="scroll">
				<view id="past0">
					...
					<view class='wrapper'>
						<!-- <view class='share1 acea-row row-between row-bottom background-image' style="background-image: url(./static/shopdetail/gcjf.png);" > -->
						<view class='share1 acea-row row-between row-bottom'>	
							<!-- <view class="bjtimg"> -->
							<image class="bjtimg" src="/static/shopdetail/gcjf.png" mode=""></image>
						<!-- 	</view> -->
						...
						<view class="share2 acea-row row-between row-bottom">
					...
					<view class="fxg attribute acea-row row-between-wrapper fangxingou" style="display: flex;justify-content: space-between;">
						<image style="width: 4rem;height: 1rem;" src="@/static/shopdetail/fxg.png" mode=""></image>
						<!-- <view class="jyps">
							<image style="width: 1rem;height: 1rem;" src="@/static/shopdetail/pzbz.png" mode=""></image>
							<view class="">差必赔</view>
						</view> -->
						<view class="jyps">
							<image style="width: 1rem;height: 1rem;" src="@/static/shopdetail/pzbz.png" mode=""></image>
							<view class="">假一赔十</view>
						</view>
						<view class="jyps">
							<image style="width: 1rem;height: 1rem;" src="@/static/shopdetail/fanli.png" mode=""></image>
							<view class="">7天退换</view>
						</view>
						<view class="jyps">
							<image style="width: 1rem;height: 1rem;" src="@/static/shopdetail/baoyou.png" mode=""></image>
							<view class="">全国包邮</view>
						</view>
					</view>
				</view>
				<view class="cjzgxsqg" style="display: flex;justify-content: space-between;padding: 10rpx 30rpx;">
					<view class="cjzg" style="font-weight: 600;">
						厂家直供，仅剩64件
					</view>
					<view class="xsqg">
						<view class="jyps2">
							<image src="@/static/shopdetail/shizhong.png" mode="" style="width:1rem;height: 1rem;"></image>
		...
		<!-- <button open-type="contact" hover-class='none' class='item'>
			...
			<!-- #endif -->
			<!-- #ifndef MP -->
			<view class="item" @tap="shouyeClick">
				<view class="iconfont icon-shouye2"></view>
				<view>首页</view>
			</view>
			...
			<view class='bnt acea-row'>
				...
				<!-- <view class='ljdh' @click="goDingdan()"> -->
				<view class='ljdh' @click="goBuy">
					立即兑换
				</view>
				<!-- <view class='ljdh2' @click="goShare">
					分享赚钱
				</view> @click="listenerActionSheet" -->
				<view class='ljdh2' @click="listenerActionSheet">
					分享赚钱
				</view> 
				<!-- <form @submit="joinCart" report-submit='true'>
					<button class='' form-type="submit">立即兑换</button>
				</form> -->
				<!-- <form @submit="joinCart" report-submit='true'>
					<button class='joinCart bnts' form-type="submit">加入购物车</button>
				</form> -->
...
<script>
	import marqueeY from '@/components/marqueeY/marqueeY';
		...
		methods: {
			...
			goCat: function(news) {
				...
				let q = {
					...
					// productAttrUnique:that.attr.productSelect.unique
			...
			//pst
			// goDingdan(){
			// 	console.log(this.storeInfo,4444)
			// 	let shop={
			...
			// 	}
			// 	console.log(shop,5555)
			// 	uni.navigateTo({
			// 		// url: '/pages/my_order/my_order?shopId=' + JSON.stringify(shop)
			// 		url: '/pages/users/order_confirm/index?shopId=' + JSON.stringify(shop)
			// 	});
			// },
			/**
			 * 立即购买
...
<style scoped lang="scss">
	...
	.product-con .footer .bnt {
		width: 440rpx;
		height: 100rpx;
		// background-color: #e93829;//pst
		
	}
	.product-con .footer .bnt .ljdh{
		color: #fff;
		display: block;
		margin: 0 auto;
		text-align: center;
...
<style scoped>
	/deep/ .countdown .time{font-size: 1rem; margin-top: 0.1rem;color: #e93829;background-color: #fff !important;padding: 0 !important;}
